...
export const BingoSizeSelection = ({currentSize, onSizeChange}) => {
    const handleGridSizeChange = (event) => onSizeChange(Number(event.target.value));
    ...
    return (
        <div className="flex flex-row gap-3 content-center py-5 items-center place-content-center">
            ...
            <select value={currentSize} onChange={handleGridSizeChange} className="py-2 px-4 rounded-lg">
