...
export const BingoGridCell = ({
  ...
  return (
    <div
      className={`flex flex-row items-center justify-center p-4 border-2 rounded border-neutral-700 transition
    ...
    >
      {editable ? (
        ...
        <h1
          className={`pointer-events-none text-xl font-medium transition transform ${
